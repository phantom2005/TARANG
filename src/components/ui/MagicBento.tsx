...
const AuthForm: React.FC<AuthFormProps> = ({
  ...
  const title = isLogin ? "Welcome Back, Musician!" : "Start Your Musical Journey!";
  const buttonText = isLogin ? "Login to Jam" : "Sign Up & Play";
  const toggleText = isLogin ? "New to the academy?" : "Already a student?";
  const toggleLinkText = isLogin ? "Enroll Now" : "Login Here";
  ...
  return (
    <ParticleCard
      ...
      particleCount={DEFAULT_PARTICLE_COUNT} // Pass particle count for consistency
    >
      ...
      <p className="mt-6 text-center text-gray-400">
        {toggleText}{" "}
        <button onClick={onToggleForm} className="text-[#8400ff] hover:underline font-medium">
          {toggleLinkText}
        </button>
      </p>
    </ParticleCard>
...
const MagicBento: React.FC<BentoProps> = ({
  ...
  // `shouldDisableAnimations` directly reflects `disableAnimations` prop
